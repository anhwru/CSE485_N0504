...
/* Focus ring. */
.rrui__checkbox__input + .rrui__checkbox__box + .rrui__checkbox__box-background:before {
  display: block;
  content: "";
  position: absolute;
...
.rrui__checkbox__input:active + .rrui__checkbox__box + .rrui__checkbox__box-background:before {
